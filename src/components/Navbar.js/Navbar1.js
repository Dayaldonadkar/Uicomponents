...
const Navbar1 = ({
  ...
  return (
    ...
    <main className="relative">
      <div
        className={`${hamburger ? "bg-green-400" : ""} ${
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            <img
              src="https://shuffle.dev/aurora-assets/logos/aurora-logo.svg"
              alt=""
            />
          </div>

          <div className="hidden md:block">
            <ul className={`${textcolor} flex space-x-4 text-sm`}>
              <li>{li}</li>
              <li>{li2}</li>
              <li>{li3}</li>
              <li>{li4}</li>
          ...
          <div
            ...
            onClick={() => toggleHam()}
          >
            {hamburger ? <CloseIcon /> : <DensityMediumIcon />}
          </div>
        </div>

        <div className="md:hidden absolute left-0 top-0 pt-3 bg-white w-5/6 px-10">
          {hamburger && (
