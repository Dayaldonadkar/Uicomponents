...
const FeaturesComponent = ({ feature, description }) => {
  return (
    <div className="">
      <div className="flex flex-col items-center lg:flex lg:flex-row lg:items-start">
        ...
        <div className="w-[95%] sm:w-[80%]">
          <h1 className="mb-4 text-xl md:text-2xl font-bold text-center lg:text-start">
            {feature}
          </h1>
          <p className="font-medium text-[#71717A] text-center lg:text-start">
            {description}
          </p>
        </div>
      </div>
